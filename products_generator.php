...
$query = $db->prepare('INSERT INTO products (name, description, date, price, rating, category, picture) VALUES (:name, :description, :date, :price, :rating, :category, :picture)');
